...
namespace reservations_data.Models.Attributes
{
    /// <summary>
    /// Custom email verification, because I don't want to allow `a@a` as a valid email...
    /// </summary>
    [AttributeUsage(AttributeTargets.Property | AttributeTargets.Field | AttributeTargets.Parameter, AllowMultiple = false)]
    public class ClientEmail : DataTypeAttribute
    {
        public ClientEmail() : base(DataType.Text)
        {
